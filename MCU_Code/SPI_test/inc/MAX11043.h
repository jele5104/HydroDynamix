...
#endif
/** * @addtogroup TP_Libraries 54
* @{ */
/** * @defgroup TP_MAX11043
* @brief    TP MAX11043 Driver for STM32F4x
...
* \par Changelog @verbatim TODO ­ defines.h ­ tm_stm32f4_spi.h @endverbatim */
...
#define PDB_POWER_DOWN  0x0400 56
